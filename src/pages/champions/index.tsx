...
import SmarphoneViewChamp from "components/feature/champions/SmartphoneViewChamp";
import DesktopViewChamp from "components/feature/champions/DesktopViewChamp";
    ...
    <>
      <div className="pt-[80px] pb-12">
        <div className="h-full flex flex-col items-center">
          ...
          {windowWidth > 767 ? (
            <DesktopViewChamp champions={champions} windowWidth={windowWidth} />
          ) : (
            <SmarphoneViewChamp />
          )}
        </div>
